...
| 4 | [原始 Day 1 Notebook](../../../experiments/esol/day01_baseline/esol_baseline.ipynb) | 回到真实代码，确认自己能找到每一部分 |
| 5 | [实验结果解释](../../../experiments/esol/day01_baseline/notes.md) | 把代码输出翻译成机器学习结论 |
...
不要一次跳到 MLP 或 GNN。完整顺序见 [算法线每日课程表](../README.md)，个人完成情况填写在 [学习进度表](../../PROGRESS.md)。
