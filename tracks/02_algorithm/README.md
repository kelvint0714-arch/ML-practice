...
当前可执行课程已经拆成 [Day 1–28 核心路线＋Day 29–35 可选 GNN 路线](LEARNING_PATH.md)。

第一次学习仍从 [Day 1 零基础学习材料](day01_beginner/README.md) 开始。Day 1 把原 Notebook 分成 Python 语法预备、全部代码逐行讲解和练习验收。仓库中的 Day 1 实验已经能运行，不等于学习者已经掌握；在能够解释 `X`、`y`、`fit`、`predict`、数据划分、指标和过拟合之前，不进入下一天。

配套入口：

- [完整每日课程表](LEARNING_PATH.md)
- [个人学习进度表](PROGRESS.md)
- [共享词典、实验协议与报错排查](shared/README.md)
- [Day 28 后的 GNN 启动条件](after_day28_gnn_gate.md)
