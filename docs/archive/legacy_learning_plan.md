...
> **归档说明：** 本文件是早期长期知识地图，目录设计和执行顺序已经被新版课程取代。当前逐日任务只以 [Day 1–28 核心课程](../../curriculum/core/README.md) 为准；不要按本文件中的旧目录树创建文件。任务卡写好也不代表本人已完成学习或实验。
